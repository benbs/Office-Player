...
var ComboboxOption = React.createClass({
  ...
  render: function () {
    ...
    cls['playlist'] = this.props.isPlaylist;
    var style = (this.props.value.image)? {backgroundImage: "url("+this.props.value.image+")"}: {}

    return (
      <li className={cx(cls)} onClick={this.onClick} style={style}>
        {this.props.children}
      </li>
    );
  },
...
var Combobox = React.createClass({
  ...
  _dataToOption: function (dataItem, idx) {
    ...
    var item = (
      <ComboboxOption
        ...
        isPlaylist={(dataItem.type == "youtube#playlist")}>
        {label}
      </ComboboxOption>
    );
    return item;
  ...
  _blur: function (evt) {
    if (evt.relatedTarget == null || !this.getDOMNode().contains(evt.relatedTarget)) {
      ...
      this._timerId = setTimeout(this.close, 500);
    }
    return false;
  },
